...
- [~] **P2-6** **FBX writer** — *(a) binary encoder DONE 2026-08-30, (b) builders next*
  ...
  - **(b) next**: builders from scene data, and the legacy-loader acceptance gate — write our bytes, load them in `FBXLoader` headless, and require the same counts and matrices the reference exporter's output produces (129 bones, 2 SkinnedMeshes, 1 clip of 53 tracks at 4.900 s).
- [ ] ~~**P2-6** **FBX writer**~~ — no *Rust* prior art. Round-trip against the 7 Mixamo reference clips.
